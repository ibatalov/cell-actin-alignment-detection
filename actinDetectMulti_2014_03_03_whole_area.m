...
SampleInfo = inputdlg({'Number of samples:','Excel file title:','actin layer number:'},'Input',1,{'1','actin alignment','2'});
...
fprintf(fileID, 'Picture;Percent of Actin area;Mean;Stdev;Median;Mode;Cell Area Fraction;OOP\n');
...
for i=1:SampleCount
    ...
    for j = 1:PictureCount
        ...
        areaCovered = areaCovered + nnz(actinMask);
        totalImageArea = totalImageArea + imSizeX*imSizeY;
        
        imageOOP = OOP(nonzero_orientation);
        
        % save data in excel file
        fprintf(fileID, [picture ';%3.3f;%3.3f;%3.3f;%3.3f;%3.3f;%3.3f;%3.3f\n'], PercentActinArea, Mean, Std, Median, Mode, (areaCovered/totalImageArea), imageOOP);
    ...
    %Save data
    fprintf(fileID, 'Average;%3.3f;%3.3f;%3.3f;%3.3f;%3.3f;%3.3f;%3.3f\n\n', PercentActinArea, Mean, Std, Median, Mode, (areaCovered/totalImageArea), OrientationOrderParameter);
